...
lex.setTokenPosition(tkn); tok = token.T_ENDWHILE; {( lex.p)++; goto _out }}
	case 43:
	{( lex.p) = ( lex.te) - 1
lex.setTokenPosition(tkn); tok = token.T_ENUM; {( lex.p)++; goto _out }}
	case 44:
	{( lex.p) = ( lex.te) - 1
...
lex.setTokenPosition(tkn); tok = token.T_TRAIT_C; {( lex.p)++; goto _out }}
	case 93:
	{( lex.p) = ( lex.te) - 1
lex.setTokenPosition(tkn); tok = token.T_HALT_COMPILER;  lex.cs = 553; {( lex.p)++; goto _out }}
	case 94:
	{( lex.p) = ( lex.te) - 1
...
lex.setTokenPosition(tkn); tok = token.T_SL; {( lex.p)++; goto _out }}
 ...
 lex.setTokenPosition(tkn); tok = token.T_STRING;   {( lex.p)++; goto _out } }
	case 156:
	{( lex.p) = ( lex.te) - 1
lex.setTokenPosition(tkn); tok = token.ID(int('"'));  lex.cs = 526; {( lex.p)++; goto _out }}
	}
 ...
 lex.te = ( lex.p)+1
{
                ...
                {( lex.p)++;  lex.cs = 135; goto _out }
            }
	goto st135
tr19:
// line internal/php8/scanner.rl:374
( lex.p) = ( lex.te) - 1
{ lex.ungetWhile('&'); lex.setTokenPosition(tkn); tok = token.T_AMPERSAND_NOT_FOLLOWED_BY_VAR_OR_VARARG; {( lex.p)++;  lex.cs = 135; goto _out } }
	goto st135
tr20:
// line internal/php8/scanner.rl:54
...
// line internal/php8/scanner.rl:372
 lex.te = ( lex.p)+1
{ lex.ungetWhile('&'); lex.setTokenPosition(tkn); tok = token.T_AMPERSAND_FOLLOWED_BY_VAR_OR_VARARG; {( lex.p)++;  lex.cs = 135; goto _out } }
	goto st135
tr26:
...
// line internal/php8/scanner.rl:329
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_ARRAY_CAST; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr53:
// line internal/php8/scanner.rl:335
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_STRING_CAST; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr57:
// line internal/php8/scanner.rl:330
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_BOOL_CAST; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr65:
// line internal/php8/scanner.rl:332
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_DOUBLE_CAST; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr72:
// line internal/php8/scanner.rl:333
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_INT_CAST; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr81:
// line internal/php8/scanner.rl:334
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_OBJECT_CAST; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr85:
// line internal/php8/scanner.rl:331
 lex.te = ( lex.p)+1
{lex.error(fmt.Sprintf("The (real) cast has been removed, use (float) instead")); {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr94:
// line internal/php8/scanner.rl:336
 lex.te = ( lex.p)+1
{lex.error(fmt.Sprintf("The (unset) cast is no longer supported")); {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr95:
// line internal/php8/scanner.rl:377
 lex.te = ( lex.p)+1
{ lex.setTokenPosition(tkn); tok = token.T_ELLIPSIS; {( lex.p)++;  lex.cs = 135; goto _out } }
	goto st135
tr98:
// line internal/php8/scanner.rl:166
( lex.p) = ( lex.te) - 1
{lex.setTokenPosition(tkn); tok = token.T_DNUMBER; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr108:
...
( lex.p) = ( lex.te) - 1
{
                ...
                if err == nil {
                    lex.setTokenPosition(tkn); tok = token.T_LNUMBER; {( lex.p)++;  lex.cs = 135; goto _out }
                }
...
( lex.p) = ( lex.te) - 1
{lex.setTokenPosition(tkn); tok = token.ID(int(';'));  lex.cs = 128; {( lex.p)++; goto _out }}
	goto _again
tr139:
	 lex.cs = 135
// line internal/php8/scanner.rl:385
 lex.te = ( lex.p)+1
{ lex.setTokenPosition(tkn); tok = token.T_NULLSAFE_OBJECT_OPERATOR;  lex.cs = 502; {( lex.p)++; goto _out } }
	goto _again
tr140:
	 lex.cs = 135
...
( lex.p) = ( lex.te) - 1
{ lex.setTokenPosition(tkn); tok = token.T_STRING;   {( lex.p)++;  lex.cs = 135; goto _out } }
	goto st135
tr146:
// line internal/php8/scanner.rl:279
( lex.p) = ( lex.te) - 1
{lex.setTokenPosition(tkn); tok = token.T_YIELD; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr157:
// line internal/php8/scanner.rl:278
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_YIELD_FROM; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr158:
// line internal/php8/scanner.rl:215
( lex.p) = ( lex.te) - 1
{lex.setTokenPosition(tkn); tok = token.T_NAME_FULLY_QUALIFIED; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr210:
// line internal/php8/scanner.rl:410
 lex.te = ( lex.p)+1
...
// line internal/php8/scanner.rl:407
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.ID(int('`'));  lex.cs = 520; {( lex.p)++; goto _out }}
	goto _again
tr260:
// line internal/php8/scanner.rl:379
 lex.te = ( lex.p)+1
{ lex.setTokenPosition(tkn); tok = token.ID(int('{')); lex.call(135, 135); goto _out; }
	goto st135
tr262:
...
// line internal/php8/scanner.rl:315
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_IS_NOT_EQUAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr273:
// line internal/php8/scanner.rl:316
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_IS_NOT_IDENTICAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr274:
	 lex.cs = 135
...
// line internal/php8/scanner.rl:297
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_ATTRIBUTE; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr280:
...
// line internal/php8/scanner.rl:381
 lex.te = ( lex.p)
( lex.p)--
{ lex.setTokenPosition(tkn); tok = token.T_VARIABLE; {( lex.p)++;  lex.cs = 135; goto _out } }
	goto st135
tr291:
// line internal/php8/scanner.rl:310
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_MOD_EQUAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr292:
// line internal/php8/scanner.rl:374
 lex.te = ( lex.p)+1
...
// line internal/php8/scanner.rl:299
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_BOOLEAN_AND; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr299:
// line internal/php8/scanner.rl:301
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_AND_EQUAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr300:
// line internal/php8/scanner.rl:374
 lex.te = ( lex.p)
...
// line internal/php8/scanner.rl:304
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_MUL_EQUAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr305:
// line internal/php8/scanner.rl:323
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_POW; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr306:
// line internal/php8/scanner.rl:305
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_POW_EQUAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr307:
// line internal/php8/scanner.rl:312
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_INC; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr308:
// line internal/php8/scanner.rl:307
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_PLUS_EQUAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr309:
// line internal/php8/scanner.rl:311
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_DEC; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr310:
// line internal/php8/scanner.rl:308
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_MINUS_EQUAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr311:
	 lex.cs = 135
// line internal/php8/scanner.rl:384
 lex.te = ( lex.p)+1
{ lex.setTokenPosition(tkn); tok = token.T_OBJECT_OPERATOR;  lex.cs = 502; {( lex.p)++; goto _out } }
	goto _again
tr313:
// line internal/php8/scanner.rl:303
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_CONCAT_EQUAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr314:
// line internal/php8/scanner.rl:166
 lex.te = ( lex.p)
...
// line internal/php8/scanner.rl:306
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_DIV_EQUAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr318:
// line internal/php8/scanner.rl:177
 lex.te = ( lex.p)
...
// line internal/php8/scanner.rl:298
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_PAAMAYIM_NEKUDOTAYIM; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr328:
	 lex.cs = 135
// line internal/php8/scanner.rl:164
...
// line internal/php8/scanner.rl:324
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_SL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr335:
// line internal/php8/scanner.rl:319
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_SL_EQUAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr336:
	 lex.cs = 135
// line internal/php8/scanner.rl:54
...
// line internal/php8/scanner.rl:322
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_IS_SMALLER_OR_EQUAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr338:
// line internal/php8/scanner.rl:314
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_SPACESHIP; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr340:
// line internal/php8/scanner.rl:313
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_DOUBLE_ARROW; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr341:
// line internal/php8/scanner.rl:317
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_IS_EQUAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr342:
// line internal/php8/scanner.rl:318
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_IS_IDENTICAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr343:
// line internal/php8/scanner.rl:321
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_IS_GREATER_OR_EQUAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr345:
// line internal/php8/scanner.rl:325
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_SR; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr346:
// line internal/php8/scanner.rl:320
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_SR_EQUAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr350:
	 lex.cs = 135
// line internal/php8/scanner.rl:163
...
// line internal/php8/scanner.rl:326
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_COALESCE; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr354:
// line internal/php8/scanner.rl:327
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_COALESCE_EQUAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr355:
// line internal/php8/scanner.rl:382
 lex.te = ( lex.p)
...
// line internal/php8/scanner.rl:214
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_NAME_QUALIFIED; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr437:
// line internal/php8/scanner.rl:233
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_ELSE; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr458:
// line internal/php8/scanner.rl:237
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_ENDFOR; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr488:
// line internal/php8/scanner.rl:246
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_FINAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr492:
// line internal/php8/scanner.rl:248
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_FOR; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr524:
// line internal/php8/scanner.rl:280
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_INCLUDE; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr567:
// line internal/php8/scanner.rl:261
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_NAMESPACE; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr569:
// line internal/php8/scanner.rl:213
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_NAME_RELATIVE; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr605:
// line internal/php8/scanner.rl:282
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_REQUIRE; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr651:
// line internal/php8/scanner.rl:279
 lex.te = ( lex.p)
...
// line internal/php8/scanner.rl:216
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_NS_SEPARATOR; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr653:
// line internal/php8/scanner.rl:215
 lex.te = ( lex.p)
...
// line internal/php8/scanner.rl:309
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_XOR_EQUAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr729:
// line internal/php8/scanner.rl:302
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_OR_EQUAL; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
tr730:
// line internal/php8/scanner.rl:300
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_BOOLEAN_OR; {( lex.p)++;  lex.cs = 135; goto _out }}
	goto st135
	st135:
// line NONE:1
 lex.ts = 0
...
( lex.p) = ( lex.te) - 1
{lex.ungetCnt(1); {goto st135 }}
	goto st502
tr163:
// line internal/php8/scanner.rl:419
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_NULLSAFE_OBJECT_OPERATOR; {( lex.p)++;  lex.cs = 502; goto _out }}
	goto st502
tr731:
// line internal/php8/scanner.rl:421
 lex.te = ( lex.p)+1
...
// line internal/php8/scanner.rl:418
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_OBJECT_OPERATOR; {( lex.p)++;  lex.cs = 502; goto _out }}
	goto st502
tr746:
	 lex.cs = 502
// line internal/php8/scanner.rl:420
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_STRING;  lex.cs = 135; {( lex.p)++; goto _out }}
	goto _again
	st502:
// line NONE:1
 lex.ts = 0
...
// line internal/php8/scanner.rl:434
 lex.te = ( lex.p)+1
{lex.ungetCnt(1); lex.setTokenPosition(tkn); tok = token.T_CURLY_OPEN; lex.call(513, 135); goto _out;}
	goto st513
tr763:
// line internal/php8/scanner.rl:436
 lex.te = ( lex.p)
( lex.p)--
{lex.ungetCnt(1); { lex.growCallStack(); { lex.stack[ lex.top] = 513;  lex.top++; goto st534 }}}
	goto st513
tr764:
// line internal/php8/scanner.rl:435
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_DOLLAR_OPEN_CURLY_BRACES; lex.call(513, 551); goto _out;}
	goto st513
tr765:
	 lex.cs = 513
// line NONE:1
...
// line internal/php8/scanner.rl:451
 lex.te = ( lex.p)+1
{lex.ungetCnt(2); { lex.growCallStack(); { lex.stack[ lex.top] = 520;  lex.top++; goto st534 }}}
	goto st520
tr167:
// line internal/php8/scanner.rl:450
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_DOLLAR_OPEN_CURLY_BRACES; lex.call(520, 551); goto _out;}
	goto st520
tr168:
// line internal/php8/scanner.rl:449
 lex.te = ( lex.p)+1
{lex.ungetCnt(1); lex.setTokenPosition(tkn); tok = token.T_CURLY_OPEN; lex.call(520, 135); goto _out;}
	goto st520
tr774:
	 lex.cs = 520
// line internal/php8/scanner.rl:452
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.ID(int('`'));  lex.cs = 135; {( lex.p)++; goto _out }}
	goto _again
tr782:
	 lex.cs = 520
// line NONE:1
...
// line internal/php8/scanner.rl:463
 lex.te = ( lex.p)+1
{lex.ungetCnt(2); { lex.growCallStack(); { lex.stack[ lex.top] = 526;  lex.top++; goto st534 }}}
	goto st526
tr170:
// line internal/php8/scanner.rl:462
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.T_DOLLAR_OPEN_CURLY_BRACES; lex.call(526, 551); goto _out;}
	goto st526
tr171:
// line internal/php8/scanner.rl:461
 lex.te = ( lex.p)+1
{lex.ungetCnt(1); lex.setTokenPosition(tkn); tok = token.T_CURLY_OPEN; lex.call(526, 135); goto _out;}
	goto st526
tr791:
	 lex.cs = 526
...
// line internal/php8/scanner.rl:489
 lex.te = ( lex.p)+1
{lex.ungetCnt(1); lex.setTokenPosition(tkn); tok = token.T_OBJECT_OPERATOR; {( lex.p)++;  lex.cs = 534; goto _out }}
	goto st534
tr175:
// line internal/php8/scanner.rl:490
 lex.te = ( lex.p)+1
{lex.ungetCnt(1); lex.setTokenPosition(tkn); tok = token.T_NULLSAFE_OBJECT_OPERATOR; {( lex.p)++;  lex.cs = 534; goto _out }}
	goto st534
tr811:
// line internal/php8/scanner.rl:493
 lex.te = ( lex.p)+1
...
// line internal/php8/scanner.rl:492
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.ID(int('[')); lex.call(534, 540); goto _out;}
	goto st534
tr817:
// line internal/php8/scanner.rl:493
 lex.te = ( lex.p)
...
// line internal/php8/scanner.rl:488
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_VARIABLE; {( lex.p)++;  lex.cs = 534; goto _out }}
	goto st534
tr822:
// line internal/php8/scanner.rl:491
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_STRING; {( lex.p)++;  lex.cs = 534; goto _out }}
	goto st534
	st534:
// line NONE:1
 lex.ts = 0
...
( lex.p) = ( lex.te) - 1
{lex.setTokenPosition(tkn); tok = token.T_NUM_STRING; {( lex.p)++;  lex.cs = 540; goto _out }}
	goto st540
tr823:
...
// line internal/php8/scanner.rl:501
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.ID(int(lex.data[lex.ts])); {( lex.p)++;  lex.cs = 540; goto _out }}
	goto st540
tr831:
...
// line internal/php8/scanner.rl:498
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_VARIABLE; {( lex.p)++;  lex.cs = 540; goto _out }}
	goto st540
tr837:
// line internal/php8/scanner.rl:497
 lex.te = ( lex.p)
...
// line internal/php8/scanner.rl:499
 lex.te = ( lex.p)
( lex.p)--
{lex.setTokenPosition(tkn); tok = token.T_STRING; {( lex.p)++;  lex.cs = 540; goto _out }}
	goto st540
	st540:
// line NONE:1
 lex.ts = 0
...
( lex.p) = ( lex.te) - 1
{lex.ungetCnt(1);  lex.cs = 135;}
	goto _again
tr183:
	 lex.cs = 551
// line internal/php8/scanner.rl:510
 lex.te = ( lex.p)+1
{lex.ungetCnt(1); lex.setTokenPosition(tkn); tok = token.T_STRING_VARNAME;  lex.cs = 135; {( lex.p)++; goto _out }}
	goto _again
tr843:
	 lex.cs = 551
// line internal/php8/scanner.rl:511
...
// line internal/php8/scanner.rl:516
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.ID(int('('));  lex.cs = 557; {( lex.p)++; goto _out }}
	goto _again
tr850:
// line internal/php8/scanner.rl:515
 lex.te = ( lex.p)
...
// line internal/php8/scanner.rl:522
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.ID(int(')'));  lex.cs = 561; {( lex.p)++; goto _out }}
	goto _again
tr861:
// line internal/php8/scanner.rl:521
 lex.te = ( lex.p)
...
tr868:
	 lex.cs = 561
// line internal/php8/scanner.rl:529
 lex.te = ( lex.p)+1
{lex.ungetCnt(1);  lex.cs = 135;}
	goto _again
tr871:
...
// line internal/php8/scanner.rl:528
 lex.te = ( lex.p)+1
{lex.setTokenPosition(tkn); tok = token.ID(int(';'));  lex.cs = 565; {( lex.p)++; goto _out }}
	goto _again
tr872:
// line internal/php8/scanner.rl:527
 lex.te = ( lex.p)
...
// line internal/php8/scanner.rl:533
 lex.te = ( lex.p)
( lex.p)--
{ lex.addFreeFloatingToken(tkn, token.T_HALT_COMPILER, lex.ts, lex.te); }
	goto st565
...
// line internal/php8/scanner.rl:537
